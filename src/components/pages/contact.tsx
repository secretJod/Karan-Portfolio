    ...
    >
      <div className="grid grid-cols-1 lg:gap-10 lg:grid-cols-2 w-full max-w-sm md:max-w-2xl lg:max-w-5xl">
        <div className="text-center mb-1">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            I'm always open to discussing AI/ML projects, software development
            opportunities, or creative collaborations. Feel free to reach out!
          </p>
        </div>
            ...
            <div className="space-y-4">
              {submitStatus === "success" && (
                <Alert className="w-full mb-6 border-green-200 bg-green-50 text-green-800 justify-center align-middle items-center">
                  ...
                  <AlertDescription>
                    Thank you for your message! Karan will get back to you as
                    soon as possible.
                  </AlertDescription>
                </Alert>
              )}
      ...
      <div className="text-center max-w-sm md:max-w-lg text-muted-foreground">
        <p className="text-sm">
          ...
          <a
            href="mailto:secret91750@gmail.com"
            target="_blank"
            aria-label="Email Karan Upadhyay"
            className="text-primary underline underline-offset-4 hover:text-primary/90"
          >
            secret91750@gmail.com
          </a>
        </p>
      </div>
    </section>
