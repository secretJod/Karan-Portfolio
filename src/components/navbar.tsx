...
// Nav links maintained to match Karan Upadhyay's portfolio sections
const navLinks: NavLink[] = [
  { id: "home", label: "Home", href: "/#home" },
  { id: "about", label: "About", href: "/#about" },
  { id: "career", label: "Career", href: "/#career" }, // This connects to your History section
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-background/60 backdrop-blur-sm shadow-muted-foreground dark:bg-background/80 transition-colors duration-300 border-b border-border">
      <div className="flex h-16 items-center justify-between px-4 md:px-8">
        <ModeToggle />
        {/* Branding placeholder or Logo could go here */}
